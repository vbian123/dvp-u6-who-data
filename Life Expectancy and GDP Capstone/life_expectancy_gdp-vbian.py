...
plt.title("Average GDP of Each Country")
plt.savefig("barAvgGDP.png")
plt.show()
...
plt.title("Average Life Expectancy of Each Country")
plt.savefig("barAvgLEABY.png")
plt.show()
...
#The two graphs do not similar
#Wwhile the GDP across countries varies significantly, the LEABY is rather consistent throughout the countries. 
#Zimbabwe has the lowest GDP and LEABY compared to the other 5 countries. 
...
plt.savefig("violinCountryLEABY.png")
plt.show()
...
#Every country, except Zimbabwe, has a life expectancy that is rather centralized and significantly longer. Zimbabwe's life expectancy has changed the most.
...
plt.savefig("barCountryLEABY.png")
plt.show()
...
#China's and USA's GDP has grown significantly over the years. Zimbabwe's GDP is almost nonexistant compared to the other countries'. 
#Zimbabwe's life expectancy has grown a lot, but it is still a lot lower than the other countries'.
#The changes are biggest around 2005 to 2015.
#Excluding Zimbabwe, Chile's GDP has had the least amount of change in GDP.
#There is some correlation in GDP growth and increase in life expectancy. Comparatively, USA and China have seemed to boom economically, but their life expectancies don't necessarily surpass Germany's and Chile's.
#As people gain the means have a higher standard of living, they gain access to more nutritious foods, better healthcare, and a safer environoment, which ultimately leads to longer life expectancies.
...
g.fig.suptitle('Life Expectancy in 6 Countries from 2000 to 2015')
plt.savefig("facetLEABYGDP.png")
plt.show()
...
#China moved along the x-axis the most
#Zimbabwe moved along the y-axis the most
#No it's not that surprising
#The scatter plots aren't that easy to read because it's difficult to compare the dots and track their movement
...
g3 = (g3.map(plt.plot, "Year", "LEABY", color = "#3498DB").add_legend())
plt.subplots_adjust(top = 0.9)
g3.fig.suptitle('Life Expectancy in 6 Countries from 2000 to 2015')
plt.savefig("facetCountryLEABY.png")
plt.show()
...
#China and Zimbabwe's lines changed the most
#From 2005-2015
#Mexico seems to have the least change in life expectancy over time
#Some countries' GDPs may not have increased as much, so their overall standard of living didn't change drastically.
...
g2 = (g2.map(plt.plot, "Year", "GDP", color = "#58D68D").add_legend())
plt.subplots_adjust(top = 0.9)
g2.fig.suptitle('GDP in 6 Countries from 2000 to 2015')
plt.savefig("facetCountryGDP.png")
plt.show()
...
#highest Life Expectancy - Germany
#lowest Life Expectancy - Zimbabwe
...
#Hyperinflation in Zimbabwe:
    ...
    #This involved redistributing land from the existing white farmers to black farmers.
    #But, with little experience, the new farmers struggled to produce food, and there was a large fall in food production.
